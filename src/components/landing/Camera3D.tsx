...
export function Camera3D() {
  ...
  useEffect(() => {
    ...
    // Camera — zoomed out for breathing room (was too tight at 5.15)
    const camera = new THREE.PerspectiveCamera(42, 1, 0.1, 100);
    camera.position.set(0, 0.9, 6.35);
    ...
    // Smaller so it breathes inside the paper - was 0.88 still tight
    cameraGroup.scale.setScalar(0.74);
    rig.add(cameraGroup);
